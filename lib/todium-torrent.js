...
//torrent is irrelevent...just to make it look like a nice torrent file url...link is what matters
app.get('/:link/:torrent', function(req, res) {
    ...
    firebase.child('torrent').child(link).once('value', function(valueSnapshot) {
        ...
        console.log('torrent', torrent, req.params.torrent);
